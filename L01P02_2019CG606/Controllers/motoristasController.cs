...
using L01P02_2019CG606.Models;

namespace L01P02_2019CG606.Controllers
{
    public class motoristasController : Controller
    {
        private readonly restaurateDbContext _context;

        public motoristasController(restaurateDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.motoristas != null ? 
                          ...
                          Problem("Entity set 'restaurateDbContext.motoristas'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'restaurateDbContext.motoristas'  is null.");
            }
            var motoristas = await _context.motoristas.FindAsync(id);
            if (motoristas != null)
            {
