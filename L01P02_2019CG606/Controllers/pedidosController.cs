...
namespace L01P02_2019CG606.Controllers
{
    public class pedidosController : Controller
    {
        ...
        public pedidosController(restaurateDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.pedidos != null ? 
                          ...
                          Problem("Entity set 'restaurateDbContext.pedidos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'restaurateDbContext.pedidos'  is null.");
            }
            var pedidos = await _context.pedidos.FindAsync(id);
            if (pedidos != null)
            {
