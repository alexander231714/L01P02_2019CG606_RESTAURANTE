...
namespace L01P02_2019CG606.Controllers
{
    public class clientesController : Controller
    {
        ...
        public clientesController(restaurateDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.clientes != null ? 
                          ...
                          Problem("Entity set 'restaurateDbContext.clientes'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'restaurateDbContext.clientes'  is null.");
            }
            var clientes = await _context.clientes.FindAsync(id);
            if (clientes != null)
            {
