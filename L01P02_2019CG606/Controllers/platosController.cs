...
namespace L01P02_2019CG606.Controllers
{
    public class platosController : Controller
    {
        ...
        public platosController(restaurateDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.platos != null ? 
                          ...
                          Problem("Entity set 'restaurateDbContext.platos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'restaurateDbContext.platos'  is null.");
            }
            var platos = await _context.platos.FindAsync(id);
            if (platos != null)
            {
